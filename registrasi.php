...
date_default_timezone_set("Asia/Jakarta");
	...
	$nohp=$_GET['nohp'];
	$custno=substr($nohp, -10);
	
	$data = array (
	"CustomerName" => "$nickname", //**opsi
    "DateOfBirth" => "2000-12-12", 
    "PrimaryID" => "$nohp", //*
    "MobileNumber" => "$nohp", //*
    "EmailAddress" => "juna@gmail.com", 
    "CompanyCode" => "88856", 
    "CustomerNumber" => "$custno", //*
    "IDNumber" => "331513123130002"); //KTP
	...
	//echo '\nencryptedData: '.$encryptedData;//echo "\n";
	//echo "\nconstruct: ".$method.":".$path.":".$access_token.":".$encryptedData.":".$timestamp;
	...
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); // Ignore Verify SSL Certificate
	curl_setopt($ch, CURLOPT_HTTPHEADER, $headers); // Ignore Verify SSL Certificate
	curl_setopt($ch, CURLOPT_POSTFIELDS, $dataEncode); // Ignore Verify SSL Certificate
	curl_setopt($ch, CURLOPT_SSLVERSION, 6);
